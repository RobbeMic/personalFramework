                ...
                <div className="grid-span-2 imageList">
                    <ul className="grid-row-2">
                        <p>
                            {
                                (!isDutch)?
                                "Usually, when we want to move to a BIM model, we would first go about fully modelling the environment. However, it is more in line with a traditional design process to build up the complexity of the model as the project progresses, but usual BIM software often does not allow adding information about objects without modelling them.":
                                "Meestal gaat men eerst de omgeving volledig na modelleren wanneer men wilt over stappen op een BIM model. Echter is het meer in lijn met een traditioneel ontwerp proces om de complexiteit van het model op te bouwen naarmate het project vorderd, maar gebruikelijke BIM software laat vaak niet toe om informatie over objecten toe te voegen zonder dat dit object gemodelleerd is."
                            }
                        </p>
                        <p>{
                            (!isDutch)?
                            ...
                            "Bij de uitwerking van mijn prototypes gaat er veel aandacht naar naar de ervaring van de gebruiker. Alhoewel er reeds meerdere kaders bestaan om specifieke aspecten, zoals schade of erfgoed, op een open-data mannier te implementeren in BIM omgevingen, vereisen deze vaak een grondige technische digitale kennis. Hierom tracht ik een omgeving te voorzien die deze kaders kan bundelen in de vorm van micro-applicaties en toe te rijken zonder dat er wordt uitgegaan van voorgaande technische kennis."    
                        }</p>
                    </ul>
