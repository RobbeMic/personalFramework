        ...
        <div className="modal">
            ...
            <div className="modalGrid">
                <div className="aspect-ratio-1 titleSquare projectDescription">
                    ...
                    <p>{
                        (!isDutch)?
                        "I am currently in my seventh year as a scouts leader and each week I still moderate a group of young adults. Throughout previous years, I have stood in front of all ages between 11 and 18, both as co-leader and as the one responsible for the group. During my career, I have learned how to work in a team in a performance-oriented way without losing sight of long-term goals or visions, in which the importance of taking regular and clear reports has been undeniable time and again.":
                        "Ik ben ondertussen mijn zevende jaar scoutsleiding aan het geven en sta ik elke week voor een groep jongvolwassenen. Doorheen de vorige jaren heb ik voor alle leeftijden tussen 11 en 18 jaar gestaan, dit zowel als mede-leider en als verantwoordelijke. Tijdens mijn carrière heb ik geleerd om in teamverband prestatie gericht te werken zonder langdurige doelen of visie's uit het oog te verliezen, hierbij is het belang van regelmatig en helder verslag te nemen keer op keer onmiskenbaar geweest."
                    }</p>

                    <h3>{(!isDutch)? "Experience as an Instructor:": "Ervaring als Instructeur:"}</h3>
                    <p>{
                        (!isDutch)? 
                        'I did my instructor course in 2021 and have also been a recognised instructor in youth work since last year. My main experience is to take groups of experienced scout leaders on courses to then coach them into outstanding team leaders. Here the focus is mainly on "soft-skills" such as supporting a team, guiding new leaders, framing group dynamics, self-reflection, etc.':
                        'Ik heb in 2021 mijn instructeurs cursus gedaan en ben sinds vorig jaar ook erkend instructeur in het jeugdwerk. Mijn voornaamste ervaring is om groepen ervaren scoutsleiders op mee te nemen op cursus om hun dan te coachen tot uit de kluiten gewassen team leiders. Hierbij ligt de focus vooral op "soft-skills" zoals een team ondersteunen, nieuwe leiders begeleiden, groepsdynamische processen kaderen, zelfreflectie, etc.'
                    }</p>
